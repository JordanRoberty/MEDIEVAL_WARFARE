    ...
    private void getRuneModifier()
    {
        foreach (InventoryItem rune in _equiped_runes)
        {
            if (rune != null)
            {
                ...
                {
                    case "commonDamageRune"
                    or "rareDamageRune"
                    or "legendaryDamageRune":
                        damage_rune *= rune.GetMutableProperty("modifier");
                        break;
                    case "commonSpeedRune"
                    or "rareSpeedRune"
                    or "legendarySpeedRune":
                        speed_rune *= rune.GetMutableProperty("modifier");
                        break;
                    case "commonFiringRateRune"
                    or "rareFiringRateRune"
                    or "legendaryFiringRateRune":
                        firing_rate_rune = rune.GetMutableProperty("modifier");
                        break;
                    case "rareHealthRune":
                        health_rune += rune.GetMutableProperty("modifier");
                        break;
                    case "commonProjectileSizeRune"
                    or "rareProjectileSizeRune"
                    or "legendaryProjectileSizeRune":
                        projectile_size_rune *= rune.GetMutableProperty("modifier");
                        break;
                    case "commonHighJumpRune"
                    or "rareHighJumpRune"
                    or "legendaryHighJumpRune":
                    ...
                    case "commonMoneyDropRateRune": // or "rareMoneyDropRateRune" or "legendaryMoneyDropRateRune
                        ...
                        break;
                    case "commonBulletSpeedRune"
                    or "rareBulletSpeedRune"
                    or "legendaryBulletSpeedRune":
                        bullet_speed_rune *= rune.GetMutableProperty("modifier");
                        break;
                    case "commonShieldRune":
                        shield_rune += rune.GetMutableProperty("modifier");
                        break;
                    case "commonCriticalHitRune"
                    or "rareCriticalHitRune"
                    or "legendaryCriticalHitRune":
